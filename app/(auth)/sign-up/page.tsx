...
export default function SignUpPage() {
  ...
  return (
    <BackgroundBeamsWithCollision className="flex justify-center min-h-screen w-full bg-gradient-to-br from-gray-100 to-gray-200 p-4">
      <div className="w-full max-w-md md:max-w-xl flex justify-center items-center">
        <motion.div
          ...
          className="w-full"
        >
          <BackgroundGradient className="rounded-[22px] p-5 sm:p-10 bg-white dark:bg-zinc-900 w-full">
          <Card className="shadow-lg w-full dark:bg-zinc-900">
            <CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full dark:bg-zinc-500" disabled={loading}>
                  {loading ? (
                    <>
